...
calibration_targets = {
  ...
  "gs fen": {
    'cmtnumber': 7,
 	   #			   pft0			pft1	   	pft2	   	pft3	    	pft4	  	pft5	
	   #			   Salix		Gram	  	Forbs		Lichens	 	Feather.	Eq	
    'GPPAllIgnoringNitrogen':	[  18.8820690607,	274.3826576447,	33.7692708053,	27.3168015709,	56.1253573927,	0.4045435257	], # ingpp     (gC/m2/year)$
    'NPPAllIgnoringNitrogen':	[  17.6547345717,	256.5477848978,	31.574268203,	25.5412094688,	52.4772091622,	0.3782481965	], # innpp     (gC/m2/year)$
    'NPPAll':			[  9.44103453	,	137.1913288,	16.8846354,	13.65840079,	28.0626787,	0.202271763	], # npp       (gC/m2/year)$
    'Nuptake':			[  0.2083127157	,	2.4274972228,	0.4286643985,	0.264582393,	0.8476754438,	0.1571325459	], # nuptake   (gN/m2/year)
    'VegCarbon': {							
      'Leaf':			[  1.2445,	128.86,	15.86025,	12.82975,	26.360125,	0.475		], # vegcl     (gC/m2)
      'Stem':			[  1.577,	0,	0,		0,		0,		0		], # vegcw     (gC/m2)
      'Root':			[  0.818235,	224.84,	102.23915,	0,		0,		1.899209773	], # vegcr     (gC/m2)
    },							
    'VegStructuralNitrogen': {							
      'Leaf':			[	1.42,	0.2,	0.24,	0.63,	1.5,	0.24	], # vegnl     (gN/m2)
      'Stem':			[	16.5,	0,	0,	0,	0,	0	], # vegnw     (gN/m2)
      'Root':			[	0.16,	0.12,	0.18,	0,	0,	0.18	], # vegnr     (gN/m2)
    },							
    'MossDeathC':		4.9989,	 	#dmossc					
    'CarbonShallow':         	3119.154,	#shlwc					
    'CarbonDeep':             	3519.835,	# deepc					
    'CarbonMineralSum':       	67641.36,	# minec					
    'OrganicNitrogenSum':	7942.156,	# soln					
    'AvailableNitrogenSum':	0.4396944,	# avln					
  },							
  ## WARNING: JUNK, PLACEHOLDER VALUES! USE AT YOUR OWN RISK!
  "maritime forest": {
    'cmtnumber': 8,
