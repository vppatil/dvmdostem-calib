...
const int MIN_EQ_YR = 500; // minimum number of years for equilibrium run
const int MAX_EQ_YR = 500; // maximum number of years for equilibrium run
const int MAX_SP_YR = 1900; // maximum number of years of spinup run;
