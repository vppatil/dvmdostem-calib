...
export SITE_SPECIFIC_INCLUDES="-I/usr/local/include"
export SITE_SPECIFIC_INCLUDES="-I/usr/include"
export SITE_SPECIFIC_LIBS="-L/usr/local/lib"
export SITE_SPECIFIC_LIBS="-L/usr/lib"
